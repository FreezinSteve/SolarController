...
// Included from credentials.h
//const char* neonUser = "xxxxx";
//const char* neonPassword = "xxxx";
...
int pushToNeon()
{
  //RestClient client = RestClient(neonURL);
  RestClient client = RestClient("restservice-neon.niwa.co.nz");
...
{
  //const size_t sendBufferSize = JSON_OBJECT_SIZE(2);  // From ArduinoHelper
  //StaticJsonBuffer<sendBufferSize> sendJsonBuffer;
  ...
  if (statusCode == 200)
  {
    //const size_t recvBufferSize = JSON_OBJECT_SIZE(1) + 60;   // From ArduinoHelper
    //StaticJsonBuffer<recvBufferSize> recvJsonBuffer;
...
{
  //const size_t bufferSize = 8*JSON_ARRAY_SIZE(1) + JSON_ARRAY_SIZE(8) + JSON_OBJECT_SIZE(1) + 8*JSON_OBJECT_SIZE(2) + 8*JSON_OBJECT_SIZE(3) + 589;  // From ArduinoHelper
  //StaticJsonBuffer<bufferSize> jsonBuffer;
  DynamicJsonBuffer jsonBuffer;
